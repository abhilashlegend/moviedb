    ...
    this.getRecommendedMovies = function(Pgno){
        ...
        return $http({
            ...
            headers: {
                 ...
                 Authorization: 'cBearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxZmNjNjA1M2FkOTcwYTNmMzZjNTlhZmI0OTlmMTAzMiIsIm5iZiI6MTc0MTE5MTAyOC45LCJzdWIiOiI2N2M4Nzc3NDkyNjRhYTU4NjY2ZTQ1ZGQiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.yqimCVW-wJ3c8MuTV1-mRAs_dfX7xuyc6YfiDnbbRhM'
            }
...
app.service('movieDetailsService', ["$http", function($http) {
